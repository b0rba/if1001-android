...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mobileDataOffWifi.apply {
            this.cardText.text = getString(R.string.mobile_data_off_card_text)
            this.buttonToggle.isChecked =
                sharedPreferences.getBoolean(MOBILE_DATA_OFF_BUTTON_STATE, false)
            this.buttonToggle.setOnCheckedChangeListener(mobileOffDataButtonListener)
        }

        // Gps Off
        binding.gpsOff.apply {
            this.cardText.text = getString(R.string.gps_off_card_text)
            this.buttonToggle.isChecked =
                sharedPreferences.getBoolean(GPS_OFF_BUTTON_STATE, false)

            this.buttonToggle.setOnCheckedChangeListener(gpsOffButtonListener)
        }

        // Bluetooth Off
        binding.bluetoothOff.apply {
            this.cardText.text = getString(R.string.bluetooth_off_card_text)
            this.buttonToggle.isChecked =
                sharedPreferences.getBoolean(BLUETOOTH_OFF_BUTTON_STATE, false)
            this.buttonToggle.setOnCheckedChangeListener(bluetoothOffButtonListener)
        }

        //Turn off wifi when leave home
        binding.wifiOff.apply {
            this.cardText.text = getString(R.string.wifi_off_card_text)
            this.buttonToggle.isChecked =
                sharedPreferences.getBoolean(WIFI_OFF_BUTTON_STATE, false)

            this.buttonToggle.setOnCheckedChangeListener(wifiOffButtonListener)
        }
    }
